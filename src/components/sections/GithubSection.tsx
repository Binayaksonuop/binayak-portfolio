    ...
    <section className={styles.section} ref={containerRef}>
      <div className={styles.content} style={{ border: '1px solid #30363D', background: '#0D1117' }}>
        <h2 style={{ fontFamily: 'monospace', color: '#C9D1D9', marginBottom: '2rem', display: 'flex', alignItems: 'center', gap: '1rem' }}>
          ...
          <a href="https://github.com/Binayaksonuop" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'none', transition: 'color 0.2s' }} onMouseEnter={(e) => e.currentTarget.style.color = '#58A6FF'} onMouseLeave={(e) => e.currentTarget.style.color = 'inherit'}>
            Binayaksonuop
          </a>
